...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2061674296ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uts_dpw&table=komen">`uts_dpw`.`komen`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=uts_dpw&table=artikel">`uts_dpw`.`artikel`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=coba&table=produk">`coba`.`produk`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="6a4a4e3f2c456622746d54472a706849">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
            ...
            Queried time
                            ...
                            targetdb="uts_dpw" targettable="komen">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `komen`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="uts_dpw" targettable="artikel">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
